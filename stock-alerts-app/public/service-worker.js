...
const CORE_ASSETS = ['/', '/style.css', '/app.js', '/manifest.webmanifest', '/icons/icon-192.png', '/icons/icon-512.png'];
...
// Cache-first pour les assets statiques, reseau pour le reste (API)
