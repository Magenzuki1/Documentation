/* ============================================================
   ...
   Raretés, table de bananes (102 normales + 5 secrètes)
   ============================================================ */
...
function valueFor(rarity, indexInRarity) {
  const table = {
    commune: [3, 5, 3, 6, 5, 6, 3, 5, 6, 3, 5, 6, 4, 6, 3, 5, 4, 6, 3, 5, 4, 6, 3, 5, 5, 4, 5, 6],
...
const TOTAL_NORMAL = NORMAL_BANANAS.length; // 102
