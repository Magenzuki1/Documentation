...
function valueFor(rarity, indexInRarity) {
  const table = {
    commune: [3, 5, 3, 6, 5, 6, 3, 5, 6, 3, 5, 6, 4, 6, 3, 5, 4, 6, 3, 5, 4, 6, 3, 5, 5, 4, 5, 6, 4, 5, 3, 6, 5, 4, 6, 5],
    peu_commune: [10, 13, 14, 11, 16, 14, 13, 16, 13, 14, 11, 15, 12, 10, 14, 12, 15, 11, 13, 14, 13, 15, 14, 12, 16, 13, 11, 14, 12, 15, 11, 14, 16, 13, 10, 15, 12],
    rare: [24, 29, 32, 35, 27, 30, 34, 29, 27, 37, 26, 33, 28, 36, 25, 31, 29, 34, 27, 32, 33, 35, 30, 32, 36, 28, 31, 34, 29, 28, 33, 26, 35],
    epique: [64, 70, 77, 83, 67, 74, 80, 86, 68, 75, 82, 66, 72, 79, 85, 69, 76, 84, 71, 65, 73, 78, 81, 70, 75, 69, 74, 84, 88, 82, 72, 80, 66, 85],
    legendaire: [190, 210, 230, 250, 205, 225, 200, 220, 240, 195, 215, 235, 245, 200, 210, 225, 190, 200, 230, 210, 245],
    mythique: [640, 770, 960, 1150, 700, 1100, 850, 750, 680, 720, 780, 820, 900, 700, 950, 800, 1050],
    secrete: [3200, 3500, 3800, 4200, 4500, 3600, 4000, 3400, 4800, 3300, 4100, 4600],
  };
